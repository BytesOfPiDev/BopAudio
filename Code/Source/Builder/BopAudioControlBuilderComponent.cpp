...
namespace BopAudio
{
    AZ_COMPONENT_IMPL(
        ...
        "BopAudioBuilderComponent",
        "{B617F3AF-E51C-40BF-884F-60323F924121}");
    ...
    void BopAudioControlBuilderComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        {
            serialize->Class<BopAudioControlBuilderComponent, AZ::Component>()
                ->Version(0)
                ->Attribute(
    ...
    void BopAudioControlBuilderComponent::GetProvidedServices(
        AZ::ComponentDescriptor::DependencyArrayType& provided)
    {
        provided.push_back(AZ_CRC_CE("BopAudioBuilderService"));
    }

    void BopAudioControlBuilderComponent::GetIncompatibleServices(
        AZ::ComponentDescriptor::DependencyArrayType& incompatible)
    {
        incompatible.push_back(AZ_CRC_CE("BopAudioBuilderService"));
    }

    void BopAudioControlBuilderComponent::GetRequiredServices(
        AZ::ComponentDescriptor::DependencyArrayType& /*required*/)
    {
    }

    void BopAudioControlBuilderComponent::GetDependentServices(
