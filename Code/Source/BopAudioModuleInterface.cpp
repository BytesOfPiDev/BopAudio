...
namespace BopAudio
{
    AZ_TYPE_INFO_WITH_NAME_IMPL(BopAudioModuleInterface, "BopAudioModuleInterface", BopAudioModuleInterfaceTypeId); // NOLINT
    ...
    BopAudioModuleInterface::BopAudioModuleInterface()
    {
        ...
        m_descriptors.insert(
            m_descriptors.end(), { BopAudioSystemComponent::CreateDescriptor(), BopAudioComponent::CreateDescriptor() });
    }
